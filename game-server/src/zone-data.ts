...
// WORKS_MIN_WEIGHT is gone (rome, 2026-08-20): it was the floor under a
// measured draw weight, and there is no measured draw any more. Every door has
// the same chance of closing, and the only thing that takes a door out of the
// draw is stranding somebody (works.ts, pickWorks).
...
// These habits require open sky, just like the weather descriptions.
export const HABIT_SKY: { line: string; room?: string }[] = [
...
export const ART_ROOMS = new Set<string>([
  ...
  "the-deep-mark",
  // ---- THE FORTRESS, EVERY ROOM BEHIND THE FOUR DOORS (2026-09-23). Naming a
  // room here costs nothing and is reversible: it adds `place` to the status
  // frame beside the terrain, and a client with no plate for the id paints what
  // it painted before. The three gate rooms are deliberately absent - they have
  // gate plates already, and a room plate would take precedence over one.
  "the-causeway",
  "the-old-road",
  "the-sally-ditch",
  "the-gatefall",
