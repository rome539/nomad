...
export const HELP_TEXT = [
  ...
  "                    LOOK A DIRECTION for a bearing: 'look east' names the",
  "                    country that way — the mountain, the scarp, the wood, the",
  "                    water, the standing things. Big ones carry a long way and",
  "                    small ones do not. Fog takes it, and so does the dark",
