...
const META_FIELDS = [
  "savedAt", "regrow", "roamRocks", "roamedGround", "altarHearts", "gibbetCut", "arrivals", "openDoors", "doorCloseAt", "fenceOut",
  ...
  "cacheSpent", "cacheRoom", "nextSurfaceAt", "events", "fishStock", "works", "nextWorksAt", "nextChainmanAt", "snowUntil",
